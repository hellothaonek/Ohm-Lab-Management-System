...
import { updateSlot } from "@/services/slotServices";
...
export default function EditSlot({ open, onOpenChange, onSuccess, slot }: EditSlotProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await updateSlot(slot.slotId.toString(), formData);
            onSuccess();
            onOpenChange(false);
        } catch (error) {
