...
import { Loader2, ChevronDown, ChevronRight, Users, Mail, X } from "lucide-react"
...
export default function GroupTab({ classId }: GroupTabProps) {
    ...
    const fetchTeamsAndUsers = async () => {
        try {
            ...
            console.log("Test team:", teamsData)
            setTeams(teamsData)
        } catch (err) {
    ...
    const handleRemoveUser = (teamId: number, userId: string) => {
        // TODO: Implement remove user functionality
        console.log("Remove user from team:", teamId, userId)
    }
        ...
        return (
            <Card>
                <CardContent className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground mb-4">No teams have been created for this class yet.</p>
                    <div className="flex justify-center">
                        <CreateGroup classId={classId} onGroupCreated={fetchTeamsAndUsers} />
                    </div>
                </CardContent>
            </Card>
        )
                    ...
                    <div key={team.teamId}>
                        <CardContent className="p-0">
                            <div className="flex items-center justify-between p-6 bg-card border-b border-border bg-secondary">
                                ...
                                <AddMember teamId={team.teamId} classId={classId} onMemberAdded={fetchTeamsAndUsers} />
                            </div>
                                ...
                                <div className="p-6 bg-background">
                                    {team.teamUsers.length > 0 ? (
                                                ...
                                                {team.teamUsers.map((user, index) => (
                                                    ...
                                                    >
                                                        ...
                                                        <DeleteMember
                                                            ...
                                                            onMemberDeleted={fetchTeamsAndUsers}
                                                        />
                                                    </div>
                                                ))}
                                            </div>
                                        ...
                                        <div className="text-center py-8">
                                            ...
                                            <p className="text-muted-foreground mb-4">This team doesn't have any members yet.</p>
                                        </div>
                                    )}
                                </div>
                            )}
