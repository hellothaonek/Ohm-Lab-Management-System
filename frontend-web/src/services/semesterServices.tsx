...
export const createSemester = async (data: { semesterName: string; semesterStartDate: string; semesterEndDate: string; semesterDescription: string; semesterStatus: string; }) => {
...
export const updateSemester = async (id: string, data: { semesterName: string; semesterStartDate: string; semesterEndDate: string; semesterDescription: string; semesterStatus: string; }) => {
